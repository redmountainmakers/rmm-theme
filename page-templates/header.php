<?php
/**
 * The customized header for the rmm-sporty child theme.
 *
...
<header id="masthead" class="site-header" role="banner">
    ...
    <div class="site-logo">
        ...
        <img src="<?php echo esc_url( get_theme_mod( 'sporty_logo' ) ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>"></a>
    </div>

<!-- #header-sidebar -->
    <!-- added widget area - customization -->
